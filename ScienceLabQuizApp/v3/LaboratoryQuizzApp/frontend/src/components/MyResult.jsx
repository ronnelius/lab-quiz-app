...
const MyResult = ({ apiBase = "https://lab-quiz-app.onrender.com" }) => {
  ...
  const [selectedTechnology, setSelectedTechnology] = useState("all"); //filter by technology
            ...
            <div className={resultStyles.filterContainer}>
                <div className={resultStyles.filterContent}>
                    <div className={resultStyles.filterButtons}>
                        <span className={resultStyles.filterLabel}>Filter by Equipment:</span>
                        <button onClick={() => handleSelectTech('all')} className={`${resultStyles.filterButton} ${
                            selectedTechnology === 'all' ? resultStyles.filterButtonActive 
                ...
                {technologies.length === 0 &&
                    ...
                    <div className={resultStyles.filterStatus}>
                        {selectedTechnology === "all" ? 
                            "Showing results for all laboratory equipment"
                            : `Showing results for ${selectedTechnology}`}
                    ...
                    {loading ? (
                        ...
                        {Array.isArray(results) && results.length === 0 && !error && (
                            <div className={resultStyles.emptyState}>
                                No results yet. Please take a quiz to see your results here.
                            </div>
                        )  }
                        </>
                    )}
