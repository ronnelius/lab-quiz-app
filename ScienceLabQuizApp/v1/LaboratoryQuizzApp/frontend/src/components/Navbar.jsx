...
import { X, Award, LogIn, LogOut, Menu  } from 'lucide-react';
...
const Navbar = ({logoSrc}) => {
    ...
    //useffect hook to show login state change
  useEffect(() => {
    try {
        ...
        <div className={navbarStyles.container}>
            ...
            <div className={navbarStyles.titleContainer}>
                        <div className={navbarStyles.titleBackground}>
                            <h1 className={navbarStyles.titleText}>Laboratory Quiz Application</h1>
                        </div>
            </div>
            ...
            <div className={navbarStyles.desktopButtonsContainer}>
                <div className={navbarStyles.spacer}></div>
                        ...
                        {loggedIn ? (
                            <button 
                                onClick={handleLogout} className={navbarStyles.logoutButton}
                            >
